...
public class HCatSparkTest {
	public static void main(String[] args) throws IOException {
		 ...
		 String dbName = "xdf";
		 String inputTable = "partition_test";
		 String outputTable = "partition_test_out";
	...
	public static void store(JavaRDD<SerializableWritable<HCatRecord>> rdd,
		...
		Job outputJob = null;
		Map<String,String> partitions = new HashMap<String, String>(2);
		partitions.put("stat_date", "20110728");
		partitions.put("province", "heilongjiang");
		try {
